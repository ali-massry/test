...
class AgriStep4Screen extends StatefulWidget {
  const AgriStep4Screen({super.key});

  @override
  State<AgriStep4Screen> createState() => AgriStep4ScreenState();
}

class AgriStep4ScreenState extends State<AgriStep4Screen> {
  ...
  Future<void> filterCrops() async {
    for (var ele in context
        ...
        .agridata!
        .crops!) {
      if (ele.cropcategoryid == context.read<AgriCubit>().cropCategoryId) {
            ...
            child: BuildButton(
                ...
                onTap: () {
                  if (selectedIndex == -1) {
                    ...
                    context.read<AgriCubit>().cropId = selectedIndex;
                    Navigator.of(context).pushNamed(Routes.agriStep5Screen);
                  }
                }),
          ),
            ...
            child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      const BuildEasyStepperWidget(length: 5, stepNow: 4),
